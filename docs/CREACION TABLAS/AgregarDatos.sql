...
insert into Ofertas(id,precioEstadia,nombre,FechaPublicacion,descripcion, alojamientoId,operador) values (1, 321312.421,'jasjdja','04/12/18','mashu  paila',1,1);
insert into Ofertas(id,precioEstadia,nombre,FechaPublicacion,descripcion, alojamientoId,operador) values (2, 321312.421,'jasjdja','04/04/18','sdadsadsa',2,2);
insert into Ofertas(id,precioEstadia,nombre,FechaPublicacion,descripcion, alojamientoId,operador) values (3, 321312.421,'jasjdja','04/02/18','dsadasdsa',3,3);
insert into Ofertas(id,precioEstadia,nombre,FechaPublicacion,descripcion, alojamientoId,operador) values (4, 321312.421,'jasjdja','04/02/18','msdadsada',4,4);
insert into Ofertas(id,precioEstadia,nombre,FechaPublicacion,descripcion, alojamientoId,operador) values (5, 321312.421,'jasjdja','04/02/18','mdsadadsa',5,5);
insert into Ofertas(id,precioEstadia,nombre,FechaPublicacion,descripcion, alojamientoId,operador) values (6, 321312.421,'jasjdja','04/02/18','masadasdaila',6,7);
insert into Ofertas(id,precioEstadia,nombre,FechaPublicacion,descripcion, alojamientoId,operador) values (7, 321312.421,'jasjdja','04/02/18','gsdfdgfda',7,6);
...
insert into reservas(id,fechallegada,cantidadDias,recargo,oferta) values(1,'23/03/18',3,0,2);
insert into reservas(id,fechallegada,cantidadDias,recargo,oferta) values(2,'22/03/18',3,0,3);
insert into reservas(id,fechallegada,cantidadDias,recargo,oferta) values(3,'02/03/18',4,0,4);
insert into reservas(id,fechallegada,cantidadDias,recargo,oferta) values(4,'12/03/18',3,0,7);
...
insert into alojamientosviviendas(id,numeroHabitaciones,menaje,idS) values (3,2,'dsaakj',1);
insert into alojamientosviviendas(id,numeroHabitaciones,menaje,idS) values (5,3,'dsaakj',2);
