 ...
 * @author Cristian 
 */
public class SolicitudAnalisisOperacion {
	 ...
	 * @param unidadTiempo - Unitdad de Tiempo (Dia Mes,Semana,Año)
	 */
	public  SolicitudAnalisisOperacion(@JsonProperty(value = "categoria") String categoria,@JsonProperty(value = "unidadTiempo") String unidadTiempo) {
