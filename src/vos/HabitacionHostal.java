...
public class HabitacionHostal  extends Alojamiento
{
	//----------------------------------------------------------------------------------------------------------------------------------
		// ATRIBUTOS
		//----------------------------------------------------------------------------------------------------------------------------------
			 ...
			 * @param tamano
			 */
			public HabitacionHostal(@JsonProperty(value="id") Integer id,@JsonProperty(value="nombre") String nombre, @JsonProperty(value="tipo") String tipo,@JsonProperty(value="ubicacion") String ubicacion,@JsonProperty(value="descripcion") String descripcion,@JsonProperty(value="costo") double costo, @JsonProperty(value="minimoPeriodo")int minimoPeriodo,@JsonProperty(value="capacidad")int capacidad,@JsonProperty(value="tipoHabitacion")String tipoHabitacion,@JsonProperty(value="numeroHabitacion")int numeroHabitacion,@JsonProperty(value="ubicacionH")String ubicacionH,@JsonProperty(value="tamano")String tamano) 
			{
